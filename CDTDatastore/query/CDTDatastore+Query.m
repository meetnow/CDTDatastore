...
- (BOOL)isTextSearchEnabled { return [self.CDTQManager isTextSearchEnabled]; }
- (NSDictionary *)listIndexes { return [self.CDTQManager listIndexes]; }
...
- (CDTQResultSet *)find:(NSDictionary *)query { return [self.CDTQManager find:query]; }
...
- (BOOL)updateAllIndexes { return [self.CDTQManager updateAllIndexes]; }
@end
