...
failureMessageForTo(^NSString * {
  return [NSString stringWithFormat:@"expected: %@ or %@, got values %@ some are missing", expected,
                                    otherExpected, actual];

});

failureMessageForNotTo(^NSString * {
  return [NSString stringWithFormat:@"expected neither: %@ or %@, got values %@", expected,
                                    otherExpected, actual];
