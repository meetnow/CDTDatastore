...
- (CDTDocumentRevision *)resolve:(NSString *)docId conflicts:(NSArray *)conflicts { return nil; }
@end
...
- (CDTDocumentRevision *)resolve:(NSString *)docId conflicts:(NSArray *)conflicts
{
    ...
    TD_Revision *tdrev = [[TD_Revision alloc] initWithDocID:docId revID:old.revId deleted:NO];
    tdrev.body = tdbody;
    CDTDocumentRevision *theReturn =
        [[CDTDocumentRevision alloc] initWithDocId:tdrev.docID
